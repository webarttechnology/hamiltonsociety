                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 mb-md-0 mb-4 text-lg-left text-center">
                            <div class="home-banner-text"  data-aos="fade-up">
                                ...
                                <div class="banner-btn discover-btn-banner">
                                    <a href="about.html" class="text-decoration-none">Call Us</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="service-inner">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-6">
                               <div class="sencare-team-inner">
                                <figure class="service-figure-mb">
                                    <img src="assets/images/sencare-team-img1.png" alt="" class="img-fluid">
                                </figure>
                                <h5>Anthony Joe</h5>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="sencare-team-inner">
                                    <figure class="service-figure-mb">
                                        <img src="assets/images/sencare-team-img2.png" alt="" class="img-fluid">
                                    </figure>
                                    <h5>John Deo</h5>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="sencare-team-inner">
                                    <figure class="service-figure-mb">
                                        <img src="assets/images/sencare-team-img3.png" alt="" class="img-fluid">
                                    </figure>
                                    <h5>Rickey Martin</h5>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="sencare-team-inner">
                                    <figure class="service-figure-mb">
                                        <img src="assets/images/sencare-team-img4.png" alt="" class="img-fluid">
                                    </figure>
                                    <h5>Anna Clark</h5>
