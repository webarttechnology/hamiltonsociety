...
<!-- Mirrored from html.designingmedia.com/sencare/comming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Oct 2023 09:22:16 GMT -->
<head>
<meta charset="UTF-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Commming Soon | Sencare</title>
...
<body>
  <!-- HEADER-SECTION -->
  <div class="banner-container-comming-soon">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 mb-md-0 mb-4">
                <h4  data-aos="fade-up">Our Website is</h4>
                <h2  data-aos="fade-left">Coming Soon</h2>
                <p class="coming-soon-text">We’re doing our best to launch asap</p>
                <p class="coming-soon-p"  data-aos="fade-right">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>
                <h4 class="subscribe-text">Subscribe to get notified!</h4>
                <div class="input-group mb-3 input-field-form">
                    <input type="text" class="form-control input-form-input" placeholder="Enter your email...">
                    <div class="input-group-append form-button">
                       <button class="btn btn-form-section" type="submit">Subscribe</button>
                    </div>
                </div>
                <p class="stay-text"  data-aos="fade-up">STAY IN TOUCH:</p>
